				...
				$.fn.validatebox.defaults.rules,
				{
					...
					mobile : {// value值为文本框中的值
						validator : function(value) {
							var reg = /^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[189])[0-9]{8}$/;
					...
					phoneAndMobile : {
						validator : function(value) {
							return /^((\(\d{2,3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?$/i
									.test(value)
									|| /^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[189])[0-9]{8}$/i.test(value);
						},
					...
					keyname : {
						validator : function(value) {
							return /^[a-zA-Z][a-zA-Z0-9_]{1,29}$/i.test(value);
						},
						message : '输入不合法（字母开头，允许2-30字符，允许字母数字下划线）'
					},
					// 汉字验证
					CHS : {
						validator : function(value) {
