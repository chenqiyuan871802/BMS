		      	...
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
							...
							<td class="kv-content" ><fmt:formatNumber value="${orderDepositPO.deposit_money}" type="number"/>元</td>
						</tr>
						<tr>
		      	...
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
							...
							<td class="kv-content">${nurseProjectPO.rmb_price }元</td>
							
							
						</tr>
						<tr>
							<td class="kv-label">颜值</td>
							<td class="kv-content">${nurseProjectPO.beauty_price}</td>
