	...
	<div class="container">
		<div class="content">
		      <div title="基本信息" data-options="closable:false" class="basic-info">
				...
				<div class="column"><span class="current">消费记录</span></div>
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
							...
							<td class="kv-content"><fmt:formatNumber type="number"  value="${orderDto.order_money}" />元<c:if test="${orderDto.pay_way=='3' }">（${orderDto.extend_beauty_num}个颜值）</c:if></td>
				...
				<form id="modifyOrder1Form" action="${ctx }/shop/orderManage/modifyOrder.jhtml"
		      	...
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
							...
							<td class="kv-content"><input  type="text"  autocomplete="off"  name="server_user_id" class="easyui-combobox" value="${orderDto.server_user_id}"	 data-options="url:'${ctx}/shop/orderManage/queryShopUser.jhtml',method:'get',valueField:'shop_user_id',textField:'username'" class="easyui-textbox" required="true" data-options="validType:'loginname'" style="width: 250px; height: 30px" ></td>
							<td class="kv-label" rowspan="3">订单备注</td>
							<td class="kv-content"  rowspan="3">
							<input  type="text" prompt="填写订单备注" value="${orderDto.order_remark}"  autocomplete="off"
		...
		<div  height="35px"
			...
			<a class="easyui-linkbutton button-complete button-success" dhref="javascript:void(0)"
			    onclick="submitFormData('modifyOrder1Form','recordList','modifyOrderWindow')" style="width: 70px">确定</a> &nbsp;
