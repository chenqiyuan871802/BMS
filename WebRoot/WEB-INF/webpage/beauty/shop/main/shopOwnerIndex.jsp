...
<body>
		      ...
		      <div title="基本信息" data-options="closable:false" class="basic-info">
		      	...
		      	<table class="kv-table">
					...
					<tr>   
							...
							<td class="kv-label">${shopCount.short_name}</td>
			    ...
			    onclick="goShop(${shopCount.shop_id})" style="width: 70px;">进入店铺</a>
							</td>
  ...
  <script type="text/javascript">
     function goShop(shop_id){
        top.location.href = '${ctx}/shop/login/goShop.jhtml?shop_id='+shop_id;
     }
  </script>
</body>
</html>