...
<body style="margin: 0; padding: 0">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="modifyPasswordForm" action="${ctx }/system/customUser/updatePassword.jhtml"
				method="post" >
			<input type="hidden" name="custom_user_id" value="${custom_user_id}"  />
				<table cellpadding=5 cellspacing=0 width=100% align="center" class="formTabel">
					...
					<tr>
						...
						<td><input id="modifyPassword" type="password"  name="password"	class="easyui-textbox" required="true" data-options="validType:'length[6,20]'" style="width: 280px; height: 30px" ></td>
					</tr>
