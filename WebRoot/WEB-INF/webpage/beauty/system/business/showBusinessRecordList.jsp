...
<div  style="height:70px;background-color: white;"  data-options="region:'north',split:false">
        ...
        <table class="searchContent">
				<tr>
							...
							<tr>
								...
								<td width="13%" style="text-align: left">
								<input type="text" name="shop_id" readonly  value="${shop_id}"  class="easyui-combobox"	 data-options="url:'${ctx}/system/shopSys/queryShop.jhtml',method:'get',valueField:'shop_id',textField:'shop_name'" style="width: 150px; " />
								</td>
   ...
   <div id="showOrderDetailWindow" class="easyui-window" title="查看详情"
		...
		style="width:1000px; height: 400px; background-color: #FFFFFF"></div>
