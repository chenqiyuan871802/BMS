	...
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			...
			<table cellpadding=5 cellspacing=0 width=100% align="center"
				...
				<tr>
					<td align="center" width="110px" rowspan="8">订单信息</td>
				...
				<tr>
					...
					<td align="right" width="110px">定金退回时间：</td>
					<td colspan="3"><fmt:formatDate value="${orderDepositPO.back_time}"
				...
				<tr>
					...
					<td colspan="3"><fmt:formatDate value="${orderDto.pay_time}"
					
							pattern="yyyy-MM-dd HH:mm" /></td>
				</tr>
				<tr>

					<td align="right" width="110px">服务员工：</td>
					<td>${orderDto.server_name}</td>
					<td align="right" width="110px">操作员工：</td>
					<td>${orderDto.handle_name }</td>
				</tr>
				<tr>
