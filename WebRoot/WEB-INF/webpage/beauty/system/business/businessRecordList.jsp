...
<div  style="height:90px;background-color: white;"  data-options="region:'north',split:false">
        <form id="queryForm" method="post">
        <table class="searchContent">
				<tr>
								<td width="6%" style="text-align: right">订单编号：</td>
								<td width="13%" style="text-align: left">
								<input type="text" name="order_id"   class="easyui-textbox"  style="width: 160px;  " />
								</td>
								<td width="6%" style="text-align: right">顾客账号：</td>
								<td width="13%" style="text-align: left">
								<input type="text" name="mobile"     class="easyui-textbox" style="width: 160px; " />
								</td>
								<td width="6%" style="text-align: right">顾客姓名：</td>
								<td width="13%" style="text-align: left">
								<input type="text" name="username"  class="easyui-textbox" style="width: 160px; " />
								</td>
							...
							<tr>
								...
								<td width="13%" style="text-align: left">
								<input type="text" name="server_name"    class="easyui-textbox" style="width: 160px; " />
								</td>
								<td width="6%" style="text-align: right">最后操作员工：</td>
								<td width="13%" style="text-align: left">
								<input type="text" name="handle_name"    class="easyui-textbox" style="width: 160px; " />
								</td>
					</tr>
							<tr>
								...
								<td width="6%" style="text-align: right">订单来源：</td>
								<td width="13%" style="text-align: left">
								<input type="text" name="order_source"  
									  class="easyui-combobox" editable="false"  data-options="data:order_sourceStore,textField:1,valueField:0" style="width: 160px;  " />
								</td>
	...
	<table id="recordList" class="easyui-datagrid" style="width: 100%; height: 100%; padding: 0px;"
		...
		<thead>
			<tr>
				...
				<th field="username" width="7%"   align="center">顾客姓名</th>
				...
				<th field="order_source"   formatter="order_sourceFormatter" width="8%" align="center">订单来源</th>
