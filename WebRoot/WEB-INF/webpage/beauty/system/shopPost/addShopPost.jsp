...
<script type="text/javascript">
 function submitShopPostData(){
			...
			$("#menuids").val(menuids);
			submitFormData('addForm','dataList','addWindow')
 }
</script>
...
<div class="easyui-panel" style="padding:5px" title="授权菜单" data-options="fit:true">
		<ul id="menuTree" class="easyui-tree" data-options="url:'${ctx }/system/shopPost/loadGrantMenuTree.jhtml',method:'get',checkbox:true,animate:true,lines:true"></ul>
	</div>
</div>
<div data-options="region:'center'" >
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;"  title="职位信息">
			<form id="addForm" action="${ctx }/system/shopPost/saveShopPost.jhtml"
				method="post" >
			 <input type="hidden" name="menuids" id="menuids"  />
				...
				<tr>
					...
					<tr>
						...
						<td><input name="post_desc" type="text"  class="easyui-textbox"
