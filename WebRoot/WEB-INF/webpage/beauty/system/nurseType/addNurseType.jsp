...
<body style="margin: 0; padding: 0">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="addForm" action="${ctx }/system/nurseType/saveNurseType.jhtml"
				method="post" >
				...
				<tr>
					...
					<tr>
						...
						<td><input  type="text"  name="type_name" required="true"
					...
					<tr>
						...
						<td><input name="type_remark" type="text"  class="easyui-textbox"
