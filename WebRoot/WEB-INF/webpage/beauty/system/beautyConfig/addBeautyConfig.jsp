...
<body style="margin: 0; padding: 0">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="addForm" action="${ctx }/system/beautyConfig/saveBeautyConfig.jhtml"
				method="post" >
				...
				<tr>
					...
					<tr>
						...
						<td><input name="buy_num" type="text"
					...
					<tr>
						...
						<td><input name="give_num" type="text"
					...
					<tr>
						...
						<td><input name="remark" type="text" required="true"  class="easyui-textbox"
		...
		<div data-options="region:'south',border:false" height="35px"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'ok'"href="javascript:void(0)"
			   onclick="submitFormData('addForm','dataList','addWindow')" style="width: 70px">保存</a> &nbsp;
