...
<body>
    <div class="order-detail">
        <div class="top">
            <div class="state"><span class="fl">已预约</span></div>
            <div class="box">
    ...
    <div class="order-detail-bottom">
        <a class="fr btn" href="#" onclick="subscribeProject()">再来一单</a>
    </div>
...
function subscribeProject(){
	 window.location.href = '${ctx}/wechat/project/goSubscribeProject.jhtml?&project_id=${orderDto.project_id}&shop_id=${orderDto.shop_id}';
}
$(function() {
	getWxConfig();
})
