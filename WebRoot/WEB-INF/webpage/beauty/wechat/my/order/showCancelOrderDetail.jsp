...
<body>
    <div class="order-detail">
        <div class="top">
            <div class="state"><span class="fl">已撤销</span></div>
            <div class="box">
        ...
        <div class="order-detail-describe mt20">
            <div class="hd">
                ...
                <p>定金退回时间：<fmt:formatDate value="${orderDepositPO.back_time}" pattern="yyyy-MM-dd HH:mm"/></p>
            </div>
            <div class="cot mt60">
                ...
                <p>撤销时间：<fmt:formatDate value="${orderDto.cancel_time}" pattern="yyyy-MM-dd HH:mm"/></p>
                <p>撤销类型：<c:if test="${orderDto.cancel_type=='1' }">
                                                                                 自身撤销
                           </c:if>
                           <c:if test="${orderDto.cancel_type=='2' }">
                                                                                商家撤销
                           </c:if>
                </p>
