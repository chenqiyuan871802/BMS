		...
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',border:false"
				...
				<form id="modifyPasswordForm"
					action="${ctx }/system/updateUserPassword.jhtml" method="post">
					<table cellpadding=5 cellspacing=0 width=100% align="center"
						class="formTabel">

						<tr>
							<td align="right" width="100px">原始密码：</td>
						...
						<tr>
							<td align="right" width="100px">登陆密码：</td>
							<td><input id="modifypwd" type="password" name="password"
								class="easyui-textbox" required="true"
								data-options="validType:'length[1,50]'"
								style="width: 280px; height: 30px"></td>
						</tr>
			...
			<div data-options="region:'south',border:false" height="35px"
				...
				<a class="easyui-linkbutton" data-options="iconCls:'ok'"
					...
					onclick="submitFormData('modifyPasswordForm','userList','modifyUserPasswordWindow')"
					style="width: 70px">保存</a> &nbsp; <a class="easyui-linkbutton"
					data-options="iconCls:'close'" href="javascript:void(0)"
					onclick="closeWindow('modifyUserPasswordWindow')" style="width: 70px">关闭</a>
			</div>
		</div>
