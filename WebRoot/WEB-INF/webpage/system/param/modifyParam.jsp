...
<body style="margin: 0; padding: 0">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="modifyParamForm" action="${ctx }/system/param/updateParam.jhtml"
				method="post" >
			   <input type="hidden"  name="param_id" value="${paramPO.param_id}" />
			   <input type="hidden"  name="param_key_old" value="${paramPO.param_key}" />
				<table cellpadding=5 cellspacing=0 width=100% align="center" class="formTabel">
				<tr>
						<td align="right" width="100px">所属分类：</td>
						<td><input name="catalog_id" type="text"  value="${paramPO.catalog_id }"
					...
					<tr>
						...
						<td><input  type="text"  name="param_name" value="${paramPO.param_name }" required="true"
					...
					<tr>
						...
						<td><input  type="text"  name="param_key" value="${paramPO.param_key }"  required="true"
				   ...
				   <tr>
					...
					<tr>
						...
						<td><input name="param_remark" type="text" value="${paramPO.param_remark }"  class="easyui-textbox"
		...
		<div data-options="region:'south',border:false" height="35px"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'ok'"href="javascript:void(0)"
			   onclick="submitFormData('modifyParamForm','paramList','modifyParamWindow')" style="width: 70px">保存</a> &nbsp;
		    <a class="easyui-linkbutton" data-options="iconCls:'close'" href="javascript:void(0)"
				onclick="closeWindow('modifyParamWindow')" style="width: 70px">关闭</a>
		</div>
	</div>
