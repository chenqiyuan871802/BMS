...
$(function(){
	...
	$("#modify_second_menu_type").combobox({  
		onSelect:function(item){
			var menu_type=item[0];
			if(menu_type=='view'){
				$("#modify_second_url").textbox({required:true})
			}else{
				$("#modify_second_url").textbox({required:false})
			}
			if(menu_type=='media_id'||menu_type=='view_limited'){
				$("#modify_second_media_id").textbox({required:true})
			}else{
				$("#modify_second_media_id").textbox({required:false})
			}
	...
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="modifySecondMenuForm" action="${ctx }/system/wechatMenu/updateWechatMenu.jhtml"
				method="post" >
				...
				<tr>
						...
						<td><input  type="text" value="${parentName}" disabled="true"
							class="easyui-textbox" 
							style="width: 280px; height: 30px" required="true"></td>
					</tr>
				<tr>
						<td align="right" width="100px">菜单名称：</td>
						<td><input name="menu_name" value="${wechatMenuPO.menu_name}"  type="text"
							class="easyui-textbox" data-options="validType:'length[1,7]'"
							style="width: 280px; height: 30px" required="true"></td>
					</tr>
					<tr>
						<td align="right" width="100px">菜单类型：</td>
						<td><input name="menu_type" value="${wechatMenuPO.menu_type}"  id="modify_second_menu_type" type="text" value="click"  editable="false" 
					...
					<tr>
						...
						<td><input name="menu_key" value="${wechatMenuPO.menu_key}"   type="text" 
							class="easyui-textbox" data-options="validType:'length[0,30]'"
							style="width: 280px; height: 30px" required="true"></td>
					</tr>
					<tr>
						<td align="right" width="100px">菜单URL：</td>
						<td><input name="url" value="${wechatMenuPO.url}"  id="modify_second_url"  type="text" 
							class="easyui-textbox" data-options="validType:'length[1,400]'"
							style="width: 280px; height: 30px" ></td>
					</tr>
					<tr>
						<td align="right" width="100px">永久素材编号：</td>
						<td><input name="media_id" value="${wechatMenuPO.media_id}"  id="modify_second_media_id" type="text" 
					...
					<tr>
						...
						<td><input name="is_auto_expand"  value="${wechatMenuPO.is_auto_expand}"  type="text" value="1"  editable="false" 
					...
					<tr>
						...
						<td><input name="sort_no"  value="${wechatMenuPO.sort_no}"  type="text"
					...
					<tr>
						...
						<td><input name="remark" type="text" value="${wechatMenuPO.remark}"   class="easyui-textbox"
		...
		<div data-options="region:'south',border:false" height="35px"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'ok'"href="javascript:void(0)"
			   onclick="submitFormData('modifySecondMenuForm','menuList','modifySecondMenuWindow','1')" style="width: 70px">保存</a> &nbsp;
		    <a class="easyui-linkbutton" data-options="iconCls:'close'" href="javascript:void(0)"
				onclick="closeWindow('modifySecondMenuWindow')" style="width: 70px">关闭</a>
		</div>
	</div>
