...
<body style="margin: 0; padding: 0">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="addDictionaryForm" action="${ctx }/system/dictionary/saveDictionary.jhtml"
				method="post" >
			 <input type="hidden"  name="dic_index_id" value="${dictionaryIndexPO.dic_index_id}" />
				<table cellpadding=5 cellspacing=0 width=100% align="center" class="formTabel">
					...
					<tr>
						...
						<td><input  type="text"  name="dic_code"  required="true" data-options="validType:'length[1,100]'"
							class="easyui-textbox" style="width: 280px; height: 30px" ></td>
					</tr>
					<tr>
						<td align="right" width="100px">字典对照值：</td>
						<td><input  type="text"  name="dic_value"  required="true" data-options="validType:'length[1,100]'"
							class="easyui-textbox" style="width: 280px; height: 30px" ></td>
					</tr>
					<tr>
						<td align="right" width="100px">显示颜色：</td>
						<td><input  type="text"  name="show_color" data-options="validType:'length[0,20]'"
							class="easyui-textbox" style="width: 280px; height: 30px" ></td>
					</tr>
					<tr>
		...
		<div data-options="region:'south',border:false" height="35px"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'ok'"href="javascript:void(0)"
			   onclick="submitFormData('addDictionaryForm','dictionaryList','addDictionaryWindow')" style="width: 70px">保存</a> &nbsp;
		    <a class="easyui-linkbutton" data-options="iconCls:'close'" href="javascript:void(0)"
				onclick="closeWindow('addDictionaryWindow')" style="width: 70px">关闭</a>
		</div>
	</div>
