...
<body style="margin: 0; padding: 0">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:false" style="padding: 5px;">
			<form id="addDictionaryIndexForm" action="${ctx }/system/dictionary/saveDictionaryIndex.jhtml"
				method="post" >
				...
				<tr>
					...
					<tr>
						...
						<td><input name="dic_remark" type="text"  class="easyui-textbox"
		...
		<div data-options="region:'south',border:false" height="35px"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'ok'"href="javascript:void(0)"
			   onclick="submitDictionIndexData('addDictionaryIndexForm','addDictionaryIndexWindow')" style="width: 70px">保存</a> &nbsp;
		    <a class="easyui-linkbutton" data-options="iconCls:'close'" href="javascript:void(0)"
				onclick="closeWindow('addDictionaryIndexWindow')" style="width: 70px">关闭</a>
		</div>
	</div>
