...
import com.beauty.wechat.model.Article;
import com.beauty.wechat.model.MusicMessageResp;
import com.beauty.wechat.model.NewsMessageResp;
...
/**
 * 
 * 类名:com.beauty.wechat.util.MessageUtil
 * 描述:微信消息处理工具类
 * 编写者:陈骑元
 * 创建时间:2017年4月29日 上午11:48:04
 * 修改说明:
 */
public class MessageUtil {
    ...
    public static Dto parseXml(HttpServletRequest request) throws Exception {
        ...
        for (Element e : elementList)
                dataDto.put(e.getName(), e.getText());
