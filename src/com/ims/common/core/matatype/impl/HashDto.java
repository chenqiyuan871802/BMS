package com.ims.common.core.matatype.impl;
...
import com.ims.common.core.asset.TypeConvertUtil;
...
public class HashDto extends HashMap<String, Object> implements Dto {
	...
	public HashDto(HttpServletRequest request) {
	    ...
	    //put(IMSCons.USERINFOKEY, WebCxt.getUserInfo(request.getSession()));*/
	}
...
/*	public UserInfoVO getUserInfo() {
		return (UserInfoVO) get(IMSCons.USERINFOKEY);
	}
*/
	/**
	 * 以Integer类型返回属性
	...
	public int getPageTotal() {
		...
		if (IMSUtils.isNotEmpty(countInteger)) {
