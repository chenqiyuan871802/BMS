...
import com.ims.common.core.web.WebApplicationContextExporterListener;
/**
 * 
 * 类描述： * <b>SpringBean加载器, 提供直接获取SpringBean的方法</b>
 * <p>
 ...
 * </p>
 * 创建人：陈骑元
 * 创建时间：2016-6-2 下午11:47:41
 * 修改人：蓝枫 
 * 修改时间：2016-6-2 下午11:47:41
 * 修改备注： 
 * @version
 */
public class IMSBeanLoader {

	private static Log log = LogFactory.getLog(IMSBeanLoader.class);
		...
		if (applicationContext == null) {
			try {
				if (log.isInfoEnabled())
					log.info("系统正在初始化...");
				applicationContext = new ClassPathXmlApplicationContext(new String[] { "ims.cxt.xml" });
				if (log.isInfoEnabled())
					log.info("初始化完成.");
			} catch (Exception e) {
